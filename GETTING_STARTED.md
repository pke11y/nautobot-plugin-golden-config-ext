...
#14 naming to docker.io/golden-config-extension/nautobot:latest-py3.7 done
```
...
Creating network "golden_config_extension_default" with the default driver
Creating volume "golden_config_extension_postgres_data" with default driver
Creating golden_config_extension_redis_1 ... 
Creating golden_config_extension_docs_1  ... 
Creating golden_config_extension_postgres_1 ... 
Creating golden_config_extension_postgres_1 ... done
Creating golden_config_extension_redis_1    ... done
Creating golden_config_extension_nautobot_1 ... 
Creating golden_config_extension_docs_1     ... done
Creating golden_config_extension_nautobot_1 ... done
Creating golden_config_extension_worker_1   ... 
Creating golden_config_extension_worker_1   ... done
...
ee90fbfabd77   golden-config-extension/nautobot:latest-py3.7   "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               golden_config_extension_worker_1
b8adb781d013   golden-config-extension/nautobot:latest-py3.7   "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   golden_config_extension_nautobot_1
d64ebd60675d   golden-config-extension/nautobot:latest-py3.7   "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   golden_config_extension_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   golden_config_extension_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   golden_config_extension_redis_1
```
...
Stopping golden_config_extension_worker_1   ... 
Stopping golden_config_extension_nautobot_1 ... 
Stopping golden_config_extension_docs_1     ... 
Stopping golden_config_extension_redis_1    ... 
Stopping golden_config_extension_postgres_1 ... 
Stopping golden_config_extension_worker_1   ... done
Stopping golden_config_extension_nautobot_1 ... done
Stopping golden_config_extension_postgres_1 ... done
Stopping golden_config_extension_redis_1    ... done
Stopping golden_config_extension_docs_1     ... done
Removing golden_config_extension_worker_1   ... 
Removing golden_config_extension_nautobot_1 ... 
Removing golden_config_extension_docs_1     ... 
Removing golden_config_extension_redis_1    ... 
Removing golden_config_extension_postgres_1 ... 
Removing golden_config_extension_postgres_1 ... done
Removing golden_config_extension_docs_1     ... done
Removing golden_config_extension_worker_1   ... done
Removing golden_config_extension_redis_1    ... done
Removing golden_config_extension_nautobot_1 ... done
Removing network golden_config_extension_default
```
...
So for example, our plugin is named `golden-config-extension`, the command would most likely be `docker logs golden_config_extension_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("golden_config_extension")
namespace.configure(
    {
        "golden_config_extension": {
            ...
            "python_ver": "3.7",
	    ...
        }
...
Or set the `INVOKE_golden_config_extension_PYTHON_VER` variable
...
Or set the `INVOKE_golden_config_extension_NAUTOBOT_VER` variable
